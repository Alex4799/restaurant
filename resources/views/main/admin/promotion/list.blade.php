                    ...
                    @foreach ($promotion as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <img src="{{asset('storage/promotion/'.$item->image)}}" class="img-thumbnail" alt="">
                                @endif
                            </td>
                            <td class="t-width-column">
                                <span>{{$item->name}}</span>
                                <div class="table-action">
                                    <a href="{{route('admin#promotionView',$item->id)}}">View</a>
                                </div>
                            </td>
                            <td>
                                @if ($item->shop_id==0)
    ...
    <div class="modal-dialog">
      <div class="modal-content">
       <div class="modal-header">
          <h1 class="modal-title fs-5 d-block w-100 text-center" id="createLabel">Promotion Create</h1>
        ...
        <div class="modal-body">
            <form action="{{route('admin#promotionCreate')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea id="editor" class="form-control" name="description" cols="30" rows="10"></textarea>
                </div>
                <div class="form-group mb-4">
                    <label class="mb-1 fw-semibold">Promo Code</label>
                    <input id="" type="text" class="form-control" name="promo_code" placeholder="Enter promo code">
                </div>
                <div class="form-group mb-4">
                    <label class="mb-1 fw-semibold">Percentage</label>
                    <input id="" type="text" class="form-control" name="percentage" placeholder="Enter percentage">
                </div>
                <div class="form-group mb-4">
                    <label class="mb-1 fw-semibold">Amount</label>
                    <input id="" type="text" class="form-control" name="amount" placeholder="Enter amount">
                </div>
                <div class="form-group mb-4">
                    <label class="mb-1 fw-semibold">Start Date</label>
                    <input id="" type="date" class="form-control" name="start_date" placeholder="Enter start date">
                </div>
                <div class="form-group mb-4">
                    <label class="mb-1 fw-semibold">End Date</label>
                    <input id="" type="date" class="form-control" name="end_date" placeholder="Enter end date">
                </div>
