    ...
    <div class="table-content">
        <form action="" class="mt-3" method="get" id="sale-filter">
                ...
                <div class="dropdown dropdown-menu-end">
                    ...
                    <ul class="dropdown-menu">
                        @foreach ($filterData['currencies'] as $item)
                            <li><a class="dropdown-item" href="{{route('admin#reportProduct',array_merge(request()->all(),['currency'=>$item->currency_code]))}}">{{$item->currency_code}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{route('admin#reportProduct',['startDate'=>request('startDate'),'endDate'=>request('endDate'),'shopFilter'=>request('shopFilter')])}}">All</a></li>
                            <li>
            ...
            <div class="d-flex align-items-center justify-content-end gap-1 mb-2">
                ...
                <a href="{{route('admin#reportProduct')}}" class="btn btn-danger">Clear</a>
            </div>
        </form>
        <div class="sale-type-btn">
            <div class="category-form2">
                <div class="d-flex align-items-center justify-content-end gap-1">
                    ...
                    <div>
                        <div class="dropdown ms-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('admin#reportProduct',array_merge(request()->all(),['groupBy'=>'daily']))}}">Daily</a></li>
                                <li><a class="dropdown-item" href="{{route('admin#reportProduct',array_merge(request()->all(),['groupBy'=>'weekly']))}}">Weekly</a></li>
                                <li><a class="dropdown-item" href="{{route('admin#reportProduct',array_merge(request()->all(),['groupBy'=>'monthly']))}}">Monthly</a></li>
                                <li><a class="dropdown-item" href="{{route('admin#reportProduct',array_merge(request()->all(),['groupBy'=>'yearly']))}}">Yearly</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody class="">
                                        @foreach ($products as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin#reportProduct',array_merge(request()->all(),['product'=>$item->product_name]))}}" class="text-bg-primary rounded p-2 pt-1" title="Report">
                ...
                <div class="py-2">
                    <div class="graph-area">
                        <div>
                            <canvas id="productsGraph"></canvas>
                        </div>
                    </div>
                </div>
            </div>
