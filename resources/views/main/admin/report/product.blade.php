    ...
    <div class="table-content">
        <form action="" class="mt-3" method="get" id="sale-filter">
                ...
                <div class="dropdown dropdown-menu-end">
                    ...
                    <ul class="dropdown-menu">
                        @foreach ($currencies as $item)
                            <li><a class="dropdown-item" href="{{route('admin#productReport',array_merge(request()->all(),['currency'=>$item->currency_code]))}}">{{$item->currency_code}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{route('admin#productReport',['startDate'=>request('startDate'),'endDate'=>request('endDate'),'shopFilter'=>request('shopFilter')])}}">All</a></li>
                            <li>
            ...
            <div class="d-flex align-items-center justify-content-end gap-1 mb-2">
                ...
                <a href="{{route('admin#productReport')}}" class="btn btn-danger">Clear</a>
            </div>
        </form>
                ...
                <div class="d-flex align-items-center justify-content-end gap-1">
                    ...
                    <div>
                        <div class="dropdown ms-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('admin#productReport',array_merge(request()->all(),['groupBy'=>'Daily']))}}">Daily</a></li>
                                <li><a class="dropdown-item" href="{{route('admin#productReport',array_merge(request()->all(),['groupBy'=>'Weekly']))}}">Weekly</a></li>
                                <li><a class="dropdown-item" href="{{route('admin#productReport',array_merge(request()->all(),['groupBy'=>'Monthly']))}}">Monthly</a></li>
                                <li><a class="dropdown-item" href="{{route('admin#productReport',array_merge(request()->all(),['groupBy'=>'Yearly']))}}">Yearly</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody class="">
                                        @foreach ($products as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin#productReport',array_merge(request()->all(),['product'=>$item->product_name]))}}" class="text-bg-primary rounded p-2 pt-1" title="Report">
